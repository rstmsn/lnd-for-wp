...
<div class="lnd-wp-status">
	...
	?>
			...
			<form class="lnd-channel-form" method="post" action="?page=<?php echo sanitize_text_field($_REQUEST['page']); ?>&f=channels">
	...
	<?php if(!isset($_REQUEST['lnd-open-channel']) && !$close_channel_confirm){ ?>
		...
		<form class="lnd-peer-form" method="post" action="?page=<?php echo sanitize_text_field($_REQUEST['page']); ?>&f=channels">
